...
export const canisterId = process.env.CANISTER_ID_BITCOIN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bitcoin.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bitcoin canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bitcoin.did.js")._SERVICE>}
 */
export const bitcoin = createActor(canisterId);
