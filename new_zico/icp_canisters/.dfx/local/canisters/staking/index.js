...
export const canisterId = process.env.CANISTER_ID_STAKING;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./staking.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the staking canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./staking.did.js")._SERVICE>}
 */
export const staking = createActor(canisterId);
