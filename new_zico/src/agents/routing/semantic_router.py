...
INTENT_EXEMPLARS: Dict[IntentCategory, List[str]] = {
    ...
    IntentCategory.STAKING: [
        "Stake 2 ETH for liquid staking rewards",
        "I want to earn staking rewards",
        "Unstake my staked ETH",
        "Convert ETH to liquid staking tokens",
        "I want to stake some ETH",
        "Help me unstake my position back to ETH",
    ...
    IntentCategory.LIQUIDITY: [
        ...
        "Add liquidity to a WETH-USDC pool on Base",
        "Remove my liquidity from the USDC pool",
        "Stake my LP tokens to earn farming rewards",
    ...
    IntentCategory.MARKET_DATA: [
        ...
        "Show me the TVL of a DeFi protocol",
    ...
    IntentCategory.EDUCATION: [
        ...
        "What are the best liquidity pools on Avalanche?",
