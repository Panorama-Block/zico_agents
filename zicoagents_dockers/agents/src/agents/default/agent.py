    ...
    async def _process_request(self, request: ChatRequest) -> AgentResponse:
        ...
        try:
            ...
            system_prompt = (
                ...
                "For general questions, respond naturally without mentioning Zico or its agents.\n"
                "Only when explicitly asked about Zico or its capabilities, use this list of available agents:\n"
                f"{chr(10).join(selected_agents_info)}\n"
                "Remember: Only mention Zico agents if directly asked about them. Otherwise, simply answer questions normally as a helpful assistant."
            )
